...
class MainWindow(QtW.QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        self.widgets.players.current_players_table.horizontalHeader().setSectionResizeMode(0, QtW.QHeaderView.ResizeMode.ResizeToContents)
        self.widgets.players.current_players_table.setHorizontalHeaderItem(1, QtW.QTableWidgetItem("Name"))
        self.widgets.players.current_players_table.horizontalHeader().setSectionResizeMode(1, QtW.QHeaderView.ResizeMode.Stretch)
        self.widgets.players.current_players_table.setHorizontalHeaderItem(2, QtW.QTableWidgetItem("Account"))
        self.widgets.players.current_players_table.horizontalHeader().setSectionResizeMode(2, QtW.QHeaderView.ResizeMode.Stretch)
        self.widgets.players.current_players_table.setHorizontalHeaderItem(3, QtW.QTableWidgetItem("UUID"))
        self.widgets.players.current_players_table.horizontalHeader().setSectionResizeMode(3, QtW.QHeaderView.ResizeMode.Stretch)
        self.widgets.players.current_players_table.setHorizontalHeaderItem(4, QtW.QTableWidgetItem("IP"))
        self.widgets.players.current_players_table.horizontalHeader().setSectionResizeMode(4, QtW.QHeaderView.ResizeMode.Stretch)
        self.widgets.players.current_players_table.setHorizontalHeaderItem(5, QtW.QTableWidgetItem("Connection Time"))
        self.widgets.players.current_players_table.horizontalHeader().setSectionResizeMode(5, QtW.QHeaderView.ResizeMode.Stretch)
        ...
        self.widgets.players.recent_players_table.horizontalHeader().setSectionResizeMode(0, QtW.QHeaderView.ResizeMode.Stretch)
        self.widgets.players.recent_players_table.setHorizontalHeaderItem(1, QtW.QTableWidgetItem("Account"))
        self.widgets.players.recent_players_table.horizontalHeader().setSectionResizeMode(1, QtW.QHeaderView.ResizeMode.Stretch)
        self.widgets.players.recent_players_table.setHorizontalHeaderItem(2, QtW.QTableWidgetItem("UUID"))
        self.widgets.players.recent_players_table.horizontalHeader().setSectionResizeMode(2, QtW.QHeaderView.ResizeMode.Stretch)
        self.widgets.players.recent_players_table.setHorizontalHeaderItem(3, QtW.QTableWidgetItem("IP"))
        self.widgets.players.recent_players_table.horizontalHeader().setSectionResizeMode(3, QtW.QHeaderView.ResizeMode.Stretch)
        self.widgets.players.recent_players_table.setHorizontalHeaderItem(4, QtW.QTableWidgetItem("Last Connection"))
        self.widgets.players.recent_players_table.horizontalHeader().setSectionResizeMode(4, QtW.QHeaderView.ResizeMode.Stretch)
        self.widgets.players.recent_players_table.setHorizontalHeaderItem(5, QtW.QTableWidgetItem("Last Disconnect"))
        self.widgets.players.recent_players_table.horizontalHeader().setSectionResizeMode(5, QtW.QHeaderView.ResizeMode.Stretch)
        ...
        self.widgets.universe.current_planets_layout.addWidget(self.widgets.universe.current_planets_data, 1)
        ...
        self.widgets.universe.current_planets_table.horizontalHeader().setSectionResizeMode(0, QtW.QHeaderView.ResizeMode.ResizeToContents)
        self.widgets.universe.current_planets_table.setHorizontalHeaderItem(1, QtW.QTableWidgetItem("X"))
        self.widgets.universe.current_planets_table.horizontalHeader().setSectionResizeMode(1, QtW.QHeaderView.ResizeMode.Stretch)
        self.widgets.universe.current_planets_table.setHorizontalHeaderItem(2, QtW.QTableWidgetItem("Y"))
        self.widgets.universe.current_planets_table.horizontalHeader().setSectionResizeMode(2, QtW.QHeaderView.ResizeMode.Stretch)
        self.widgets.universe.current_planets_table.setHorizontalHeaderItem(3, QtW.QTableWidgetItem("System"))
        self.widgets.universe.current_planets_table.horizontalHeader().setSectionResizeMode(3, QtW.QHeaderView.ResizeMode.Stretch)
        self.widgets.universe.current_planets_table.setHorizontalHeaderItem(4, QtW.QTableWidgetItem("Orbital"))
        self.widgets.universe.current_planets_table.horizontalHeader().setSectionResizeMode(4, QtW.QHeaderView.ResizeMode.ResizeToContents)
        self.widgets.universe.current_planets_table.setHorizontalHeaderItem(5, QtW.QTableWidgetItem("Letter"))
        self.widgets.universe.current_planets_table.horizontalHeader().setSectionResizeMode(5, QtW.QHeaderView.ResizeMode.ResizeToContents)
        self.widgets.universe.current_planets_table.setHorizontalHeaderItem(6, QtW.QTableWidgetItem("Time Loaded"))
        self.widgets.universe.current_planets_table.horizontalHeader().setSectionResizeMode(6, QtW.QHeaderView.ResizeMode.Stretch)
        self.widgets.universe.current_planets_table.setHorizontalHeaderItem(7, QtW.QTableWidgetItem("Nickname"))
        self.widgets.universe.current_planets_table.horizontalHeader().setSectionResizeMode(7, QtW.QHeaderView.ResizeMode.Stretch)
        ...
        self.widgets.universe.recent_planets_layout.addWidget(self.widgets.universe.recent_planets_data, 1)
        ...
        self.widgets.universe.recent_planets_table.horizontalHeader().setSectionResizeMode(0, QtW.QHeaderView.ResizeMode.ResizeToContents)
        self.widgets.universe.recent_planets_table.setHorizontalHeaderItem(1, QtW.QTableWidgetItem("X"))
        self.widgets.universe.recent_planets_table.horizontalHeader().setSectionResizeMode(1, QtW.QHeaderView.ResizeMode.Stretch)
        self.widgets.universe.recent_planets_table.setHorizontalHeaderItem(2, QtW.QTableWidgetItem("Y"))
        self.widgets.universe.recent_planets_table.horizontalHeader().setSectionResizeMode(2, QtW.QHeaderView.ResizeMode.Stretch)
        self.widgets.universe.recent_planets_table.setHorizontalHeaderItem(3, QtW.QTableWidgetItem("System"))
        self.widgets.universe.recent_planets_table.horizontalHeader().setSectionResizeMode(3, QtW.QHeaderView.ResizeMode.Stretch)
        self.widgets.universe.recent_planets_table.setHorizontalHeaderItem(4, QtW.QTableWidgetItem("Orbital"))
        self.widgets.universe.recent_planets_table.horizontalHeader().setSectionResizeMode(4, QtW.QHeaderView.ResizeMode.ResizeToContents)
        self.widgets.universe.recent_planets_table.setHorizontalHeaderItem(5, QtW.QTableWidgetItem("Letter"))
        self.widgets.universe.recent_planets_table.horizontalHeader().setSectionResizeMode(5, QtW.QHeaderView.ResizeMode.ResizeToContents)
        self.widgets.universe.recent_planets_table.setHorizontalHeaderItem(6, QtW.QTableWidgetItem("Time Loaded"))
        self.widgets.universe.recent_planets_table.horizontalHeader().setSectionResizeMode(6, QtW.QHeaderView.ResizeMode.Stretch)
        self.widgets.universe.recent_planets_table.setHorizontalHeaderItem(7, QtW.QTableWidgetItem("Nickname"))
        self.widgets.universe.recent_planets_table.horizontalHeader().setSectionResizeMode(7, QtW.QHeaderView.ResizeMode.Stretch)
        ...
        self.widgets.ships.current_ships_layout.addWidget(self.widgets.ships.current_ships_data, 1)
        ...
        self.widgets.ships.current_ships_table.horizontalHeader().setSectionResizeMode(0, QtW.QHeaderView.ResizeMode.Stretch)
        self.widgets.ships.current_ships_table.setHorizontalHeaderItem(1, QtW.QTableWidgetItem("X"))
        self.widgets.ships.current_ships_table.horizontalHeader().setSectionResizeMode(1, QtW.QHeaderView.ResizeMode.Stretch)
        self.widgets.ships.current_ships_table.setHorizontalHeaderItem(2, QtW.QTableWidgetItem("Y"))
        self.widgets.ships.current_ships_table.horizontalHeader().setSectionResizeMode(2, QtW.QHeaderView.ResizeMode.Stretch)
        self.widgets.ships.current_ships_table.setHorizontalHeaderItem(3, QtW.QTableWidgetItem("System"))
        self.widgets.ships.current_ships_table.horizontalHeader().setSectionResizeMode(3, QtW.QHeaderView.ResizeMode.Stretch)
        self.widgets.ships.current_ships_table.setHorizontalHeaderItem(4, QtW.QTableWidgetItem("Orbital"))
        self.widgets.ships.current_ships_table.horizontalHeader().setSectionResizeMode(4, QtW.QHeaderView.ResizeMode.Stretch)
        self.widgets.ships.current_ships_table.setHorizontalHeaderItem(5, QtW.QTableWidgetItem("Letter"))
        self.widgets.ships.current_ships_table.horizontalHeader().setSectionResizeMode(5, QtW.QHeaderView.ResizeMode.Stretch)
        self.widgets.ships.current_ships_table.setHorizontalHeaderItem(6, QtW.QTableWidgetItem("Time Loaded"))
        self.widgets.ships.current_ships_table.horizontalHeader().setSectionResizeMode(6, QtW.QHeaderView.ResizeMode.Stretch)
        ...
        self.widgets.ships.recent_ships_layout.addWidget(self.widgets.ships.recent_ships_data, 1)
        ...
        self.widgets.ships.recent_ships_table.horizontalHeader().setSectionResizeMode(0, QtW.QHeaderView.ResizeMode.Stretch)
        self.widgets.ships.recent_ships_table.setHorizontalHeaderItem(1, QtW.QTableWidgetItem("X"))
        self.widgets.ships.recent_ships_table.horizontalHeader().setSectionResizeMode(1, QtW.QHeaderView.ResizeMode.Stretch)
        self.widgets.ships.recent_ships_table.setHorizontalHeaderItem(2, QtW.QTableWidgetItem("Y"))
        self.widgets.ships.recent_ships_table.horizontalHeader().setSectionResizeMode(2, QtW.QHeaderView.ResizeMode.Stretch)
        self.widgets.ships.recent_ships_table.setHorizontalHeaderItem(3, QtW.QTableWidgetItem("System"))
        self.widgets.ships.recent_ships_table.horizontalHeader().setSectionResizeMode(3, QtW.QHeaderView.ResizeMode.Stretch)
        self.widgets.ships.recent_ships_table.setHorizontalHeaderItem(4, QtW.QTableWidgetItem("Orbital"))
        self.widgets.ships.recent_ships_table.horizontalHeader().setSectionResizeMode(4, QtW.QHeaderView.ResizeMode.Stretch)
        self.widgets.ships.recent_ships_table.setHorizontalHeaderItem(5, QtW.QTableWidgetItem("Letter"))
        self.widgets.ships.recent_ships_table.horizontalHeader().setSectionResizeMode(5, QtW.QHeaderView.ResizeMode.Stretch)
        self.widgets.ships.recent_ships_table.setHorizontalHeaderItem(6, QtW.QTableWidgetItem("Time Loaded"))
        self.widgets.ships.recent_ships_table.horizontalHeader().setSectionResizeMode(6, QtW.QHeaderView.ResizeMode.Stretch)
        self.widgets.ships.recent_ships_table.setHorizontalHeaderItem(7, QtW.QTableWidgetItem("Time Unloaded"))
        self.widgets.ships.recent_ships_table.horizontalHeader().setSectionResizeMode(7, QtW.QHeaderView.ResizeMode.Stretch)
        ...
        self.widgets.stats.current_stats_players_data.setAlignment(QtC.Qt.AlignmentFlag.AlignRight)
        ...
        self.widgets.stats.current_stats_planets_data.setAlignment(QtC.Qt.AlignmentFlag.AlignRight)
        ...
        self.widgets.stats.current_stats_ships_data.setAlignment(QtC.Qt.AlignmentFlag.AlignRight)
        ...
        self.widgets.stats.current_session_players_login_data.setAlignment(QtC.Qt.AlignmentFlag.AlignRight)
        ...
        self.widgets.stats.current_session_players_logout_data.setAlignment(QtC.Qt.AlignmentFlag.AlignRight)
        ...
        self.widgets.stats.current_session_planet_loaded_data.setAlignment(QtC.Qt.AlignmentFlag.AlignRight)
        ...
        self.widgets.stats.current_session_planet_unloaded_data.setAlignment(QtC.Qt.AlignmentFlag.AlignRight)
        ...
        self.widgets.stats.current_session_ships_loaded_data.setAlignment(QtC.Qt.AlignmentFlag.AlignRight)
        ...
        self.widgets.stats.current_session_ships_unloaded_data.setAlignment(QtC.Qt.AlignmentFlag.AlignRight)
        ...
        self.widgets.stats.current_session_players_warped_data.setAlignment(QtC.Qt.AlignmentFlag.AlignRight)
        ...
        self.widgets.stats.current_session_ships_travel_data.setAlignment(QtC.Qt.AlignmentFlag.AlignRight)
        ...
        self.widgets.stats.current_session_server_events_data.setAlignment(QtC.Qt.AlignmentFlag.AlignRight)
        ...
        self.widgets.stats.current_session_events_data.setAlignment(QtC.Qt.AlignmentFlag.AlignRight)
        ...
        self.widgets.stats.current_session_chat_entries_data.setAlignment(QtC.Qt.AlignmentFlag.AlignRight)
        ...
        self.widgets.stats.current_session_up_time_data.setAlignment(QtC.Qt.AlignmentFlag.AlignRight)
        ...
        self.widgets.stats.past_session_players_login_data.setAlignment(QtC.Qt.AlignmentFlag.AlignRight)
        ...
        self.widgets.stats.past_session_players_logout_data.setAlignment(QtC.Qt.AlignmentFlag.AlignRight)
        ...
        self.widgets.stats.past_session_planet_loaded_data.setAlignment(QtC.Qt.AlignmentFlag.AlignRight)
        ...
        self.widgets.stats.past_session_planet_unloaded_data.setAlignment(QtC.Qt.AlignmentFlag.AlignRight)
        ...
        self.widgets.stats.past_session_ships_loaded_data.setAlignment(QtC.Qt.AlignmentFlag.AlignRight)
        ...
        self.widgets.stats.past_session_ships_unloaded_data.setAlignment(QtC.Qt.AlignmentFlag.AlignRight)
        ...
        self.widgets.stats.past_session_players_warped_data.setAlignment(QtC.Qt.AlignmentFlag.AlignRight)
        ...
        self.widgets.stats.past_session_ships_travel_data.setAlignment(QtC.Qt.AlignmentFlag.AlignRight)
        ...
        self.widgets.stats.past_session_server_events_data.setAlignment(QtC.Qt.AlignmentFlag.AlignRight)
        ...
        self.widgets.stats.past_session_events_data.setAlignment(QtC.Qt.AlignmentFlag.AlignRight)
        ...
        self.widgets.stats.past_session_chat_entries_data.setAlignment(QtC.Qt.AlignmentFlag.AlignRight)
        ...
        self.widgets.stats.past_session_up_time_data.setAlignment(QtC.Qt.AlignmentFlag.AlignRight)
        ...
        self.widgets.stats.overall_players_login_data.setAlignment(QtC.Qt.AlignmentFlag.AlignRight)
        ...
        self.widgets.stats.overall_players_logout_data.setAlignment(QtC.Qt.AlignmentFlag.AlignRight)
        ...
        self.widgets.stats.overall_planet_loaded_data.setAlignment(QtC.Qt.AlignmentFlag.AlignRight)
        ...
        self.widgets.stats.overall_planet_unloaded_data.setAlignment(QtC.Qt.AlignmentFlag.AlignRight)
        ...
        self.widgets.stats.overall_ships_loaded_data.setAlignment(QtC.Qt.AlignmentFlag.AlignRight)
        ...
        self.widgets.stats.overall_ships_unloaded_data.setAlignment(QtC.Qt.AlignmentFlag.AlignRight)
        ...
        self.widgets.stats.overall_players_warped_data.setAlignment(QtC.Qt.AlignmentFlag.AlignRight)
        ...
        self.widgets.stats.overall_ships_travel_data.setAlignment(QtC.Qt.AlignmentFlag.AlignRight)
        ...
        self.widgets.stats.overall_server_events_data.setAlignment(QtC.Qt.AlignmentFlag.AlignRight)
        ...
        self.widgets.stats.overall_events_data.setAlignment(QtC.Qt.AlignmentFlag.AlignRight)
        ...
        self.widgets.stats.overall_chat_entries_data.setAlignment(QtC.Qt.AlignmentFlag.AlignRight)
        ...
        self.widgets.stats.overall_up_time_data.setAlignment(QtC.Qt.AlignmentFlag.AlignRight)
        ...
        self.widgets.config.accounts_table.horizontalHeader().setSectionResizeMode(0, QtW.QHeaderView.ResizeMode.Stretch)
        self.widgets.config.accounts_table.setHorizontalHeaderItem(1, QtW.QTableWidgetItem("Password"))
        self.widgets.config.accounts_table.horizontalHeader().setSectionResizeMode(1, QtW.QHeaderView.ResizeMode.Stretch)
        self.widgets.config.accounts_table.setHorizontalHeaderItem(2, QtW.QTableWidgetItem("Admin"))
        self.widgets.config.accounts_table.horizontalHeader().setSectionResizeMode(2, QtW.QHeaderView.ResizeMode.ResizeToContents)
        ...
        self.widgets.config.banned_ips_table.horizontalHeader().setSectionResizeMode(0, QtW.QHeaderView.ResizeMode.Stretch)
        self.widgets.config.banned_ips_table.setHorizontalHeaderItem(1, QtW.QTableWidgetItem("Reason"))
        self.widgets.config.banned_ips_table.horizontalHeader().setSectionResizeMode(1, QtW.QHeaderView.ResizeMode.Stretch)
        ...
        self.widgets.config.banned_uuids_table.horizontalHeader().setSectionResizeMode(0, QtW.QHeaderView.ResizeMode.Stretch)
        self.widgets.config.banned_uuids_table.setHorizontalHeaderItem(1, QtW.QTableWidgetItem("Reason"))
        self.widgets.config.banned_uuids_table.horizontalHeader().setSectionResizeMode(1, QtW.QHeaderView.ResizeMode.Stretch)
        ...
        self.widgets.mods.mods_table.horizontalHeader().setSectionResizeMode(0, QtW.QHeaderView.ResizeMode.Stretch)
        self.widgets.mods.mods_table.setHorizontalHeaderItem(1, QtW.QTableWidgetItem("Path"))
        self.widgets.mods.mods_table.horizontalHeader().setSectionResizeMode(1, QtW.QHeaderView.ResizeMode.Stretch)
        self.widgets.mods.mods_table.setHorizontalHeaderItem(2, QtW.QTableWidgetItem("Status"))
        self.widgets.mods.mods_table.horizontalHeader().setSectionResizeMode(2, QtW.QHeaderView.ResizeMode.ResizeToContents)
        ...
        # Customization Tab
        self.widgets.customization = Widgets()
        self.widgets.customization.widget = QtW.QWidget()
        self.widgets.customization.layout = QtW.QVBoxLayout()
        self.widgets.customization.widget.setLayout(self.widgets.customization.layout)
        self.widgets.tab_widget.addTab(self.widgets.customization.widget, "Customization")
